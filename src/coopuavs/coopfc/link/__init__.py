...
__all__ = ["BATT_CODES", "BATT_NAMES", "Channel", "FAILSAFE_CODES",
           "FAILSAFE_NAMES", "FrameDecoder", "MAX_PAYLOAD", "MODE_CODES",
           "MODE_NAMES", "MSG", "STATE_CODES", "STATE_NAMES", "decode_msg",
           "encode_frame", "encode_msg"]
